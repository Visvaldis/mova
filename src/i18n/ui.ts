...
export const ui = {
  en: {
    ...
    'soundShift.note2': 'After 2,000 more years of smaller changes, the modern English words emerge.',
  ...
  uk: {
    ...
    'soundShift.note2': 'Після ще 2 000 років менших змін постають сучасні англійські слова.',
